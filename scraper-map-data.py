...
page = requests.get('https://www.bing.com/maps/')
#print(page)
# Create a BeautifulSoup object
soup = BeautifulSoup(page.text, 'html.parser')
# get the repo list
repo = soup.find(class_="distanceLine")
print(repo)
# find all instances of that class (should return 25 as shown in the github main page)
# repo_list = repo.find_all(class_='distanceLine')
# print(len(repo_list))
...
#     f.writerow([developer, repo_name, stars])
    # # get the repo list
    # repo = soup.find('div')#class_="multimode")
    # print(repo)

# # find all instances of that class (should return 25 as shown in the github main page)
# repo_list = repo.findAll(id_='defaultPrintMessage')#class_='distanceLine')
